...
<pre>GET <?php echo $prefix ?><strong>/collections/links/segments/mp3/get</strong>?<strong>limit=5</strong>&amp;<strong>sort_direction=desc</strong>&amp;<strong>sort_field=contributed_at</strong>&amp;<strong>format=xspf</strong></pre>

<h4 id="example-1-response">Réponse</h4>
<pre class="sh_xml"><?php echo htmlentities('
<?xml version="1.0"?>
...
<pre>GET <?php echo $prefix?><strong>/collections/links/segments/youtube/get</strong>?<strong>limit=1</strong>&amp;<strong>sort_direction=asc</strong>&amp;<strong>sort_field=contributed_at</strong>&amp;<strong>contributor_name=mbertier</strong>&amp;<strong>format=json</strong></pre>

<h4 id="example-2-response">Réponse</h4>
<pre class="sh_javascript"><?php echo htmlentities('
[
  {
...
<pre>GET <?php echo $prefix?><strong>/collections/links/segments/youtube/get</strong>?<strong>limit=-1</strong>&amp;<strong>discusion_id=1679</strong>&amp;<strong>format=php</strong></pre>

<h4 id="example-3-response">Réponse (tronquée)</h4>
<pre class="sh_php"><?php echo htmlentities('
a:6:{
  i:0;a:10:{
