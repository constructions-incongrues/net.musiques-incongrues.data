...
<pre>GET <?php echo url_for('@resources_collection_segment_get?collection=links&segment=images', true) ?></pre>
...
<pre>GET <?php echo url_for('@resources_collection_segment_get?collection=links&segment=images', true) ?>?<strong>limit=3</strong></pre>
...
<pre>GET <?php echo url_for('@resources_collection_segment_get?collection=links&segment=images&limit=3', true) ?>&amp;<strong>sort_field=discussion_id</strong>&amp;<strong>sort_direction=desc</strong></pre>
...
<pre>GET <?php echo url_for('@resources_collection_segment_get?collection=links&segment=images&limit=3&sort_field=discussion_id&sort_direction=desc', true) ?>&amp;<strong>format=json</strong></pre>
...
<pre>GET <?php echo url_for('@resources_collection_segment_get?collection=links&segment=images&limit=3&sort_field=discussion_id&sort_direction=desc&format=json', true) ?>&amp;<strong>contributor_name=mbertier</strong></pre>
...
$('#howto-response-test')
    .load('<?php echo url_for('@resources_collection_segment_get?collection=links&segment=images&limit=3&sort_field=discussion_id&sort_direction=desc&format=json&contributor_name=mbertier') ?>');
</script>
<p>
