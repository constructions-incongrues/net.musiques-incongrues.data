...
class CI_Search_Formatter_Rss
{
	...
	public function format(array $resources) {
		...
		$feed->setLink('http://data.musiques-incongrues.net');
		...
		foreach ($resources as $resource) {
			...
			$entry->setLink(sprintf('http://www.musiques-incongrues.net/forum/discussion/%d/%s', $resource['discussion_id'], $this->cleanupString($resource['discussion_name'])));
			...
			$entry->setEnclosure(array('uri' => $resource['url'], 'type' => $mimeType, 'length' => 1));
